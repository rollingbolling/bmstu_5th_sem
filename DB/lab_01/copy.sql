...
copy pet(nameP,gender,weightP,birthDate,roomNumber) from 'C:\Users\danya\Desktop\bmstu_5th_sem\DB\lab_01\data\pet.csv' DELIMITER ',' CSV HEADER;
...
copy doctor_pet(id_pet,id_doctor) from 'C:\Users\danya\Desktop\bmstu_5th_sem\DB\lab_01\data\doctor_pet.csv' DELIMITER ',' CSV HEADER;
